...
<article <?php tribe_classes( $classes ); ?>>
	<div class="tribe-events-calendar-day__event-content tribe-common-g-col">
		...
		<div class="tribe-events-calendar-day__event-details">
            ...
            <a class="w-btn us-btn-style_4 usg_btn_1 icon_atright tribe-events-calendar-day__event-discover-more" href="<?php echo esc_url( $event->permalink ); ?>"><span class="w-btn-label"><?php echo __('Discover more', 'wm-child-maremma'); ?></span><i class="fal fa-long-arrow-right"></i></a>
		</div>
